...
MY_PV="61223862921d2b1d4f88436ad9c89ddc879a5699"

DESCRIPTION="The most basic dynamic function row daemon possible"
HOMEPAGE="https://github.com/kekrby/tiny-dfr"
SRC_URI="
	${CARGO_CRATE_URIS}
	https://github.com/kekrby/tiny-dfr/archive/${MY_PV}.tar.gz -> ${P}.tar.gz
"
...
src_install() {
	...
	newinitd "${FILESDIR}/tiny-dfr.initd" tiny-dfr
}
